...
void AStarPather::printSquare(const Square& s)
{
...
void AStarPather::buildPath(const Square& goal, PathRequest& request)
{
...
void AStarPather::rubberBand(const Square& goal, PathRequest& request)
{
...
bool AStarPather::wallsInRect(GridPos a, GridPos b)
{
...
void AStarPather::rubberToSmooth()
{
...
bool AStarPather::validNeighbor(const int& row, const int& col, const GridPos& prev)
{
...
void AStarPather::evaluateChildren(const Square& parent, const GridPos& pos, const GridPos& prev, const GridPos& goal, const PathRequest& request)
{
...
void AStarPather::computeCost(const Square& parent, GridPos parent_pos, const int& row, const int& col, const float& dist, const GridPos& goal, const PathRequest& request)
{
...
void AStarPather::insertSortList(const Square& node, XY child_xy)
{
    if (ol_size == 0)
    {
        openlist[ol_size] = child_xy;
...
float AStarPather::CalcHeuristicCost(const int& x1, const int& y1, const int& x2, const int& y2, const PathRequest& request)
{
...
float AStarPather::H_Euclidean(const int& x1, const int& y1, const int& x2, const int& y2)
{
    int dx = x1 - x2;
    int dy = y1 - y2;
...
float AStarPather::H_Octile(const int& x1, const int& y1, const int& x2, const int& y2)
{
    int dx = abs(x1 - x2);
    int dy = abs(y1 - y2);
    if (dx < dy)
...
float AStarPather::H_Manhattan(const int& x1, const int& y1, const int& x2, const int& y2)
{
    return static_cast<float>(abs(x1 - x2) + abs(y1 - y2));
}

// Chebyshev Distance Heuristic
float AStarPather::H_Chebyshev(const int& x1, const int& y1, const int& x2, const int& y2)
{
    int dx = abs(x1 - x2);
    int dy = abs(y1 - y2);
    if (dx > dy)
